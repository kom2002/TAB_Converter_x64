 ...
 */
bool __stdcall mycb 
(unsigned long fcnt, unsigned long bcnt, struct mad_header *mhdr) {
	...
	if (fcnt == 1) {
		...
		/*
		 * Uncomment the following line of code to test cancelling
		 * of the conversion. Any time you return 'false', conversion
		 * will end.
		 */
		// if (fcnt == 100) return false;
