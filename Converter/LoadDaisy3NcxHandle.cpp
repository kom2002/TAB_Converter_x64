									   ...
									   const Attributes& att)
{
		...
		||!strcmp(message1,"SMILCUSTOMTEST"))
	{
		...
		if (att.getIndex(XMLString::transcode("id")) != -1 )
		{
			...
			try
			{
				...
				message2 = XMLString::transcode(att.getValue(myXMLCh));
				if (message2 == NULL)	vecDaisy3NcxCustomTestId.push_back("EmPtY");
				else			vecDaisy3NcxCustomTestId.push_back(message2);
				XMLString::release(&myXMLCh);
				XMLString::release(&message2);
			...
			try
			{
				...
				message2 = XMLString::transcode(att.getValue(myXMLCh));
				if (message2 == NULL)	vecDaisy3NcxCustomTestOverride.push_back("EmPtY");
				else					vecDaisy3NcxCustomTestOverride.push_back(message2);
				XMLString::release(&myXMLCh);
				XMLString::release(&message2);
			...
			try
			{
				myXMLCh = XMLString::transcode("bookStruct");
				message2 = XMLString::transcode(att.getValue(myXMLCh));
				if (message2 == NULL)	vecDaisy3NcxCustomTestBookStruct.push_back("EmPtY");
				else					vecDaisy3NcxCustomTestBookStruct.push_back(message2);
				XMLString::release(&myXMLCh);
				XMLString::release(&message2);
		...
		||!strcmp(message1,"META"))
	{
		...
		if (att.getIndex(XMLString::transcode("name")) != -1 )
		{
			...
			try
			{
				...
				message2 = XMLString::transcode(att.getValue(myXMLCh));
				if (message2 == NULL)	vecDaisy3NcxMetaName.push_back("EmPtY");
				else					vecDaisy3NcxMetaName.push_back(message2);
				XMLString::release(&myXMLCh);
				XMLString::release(&message2);
			...
			try
			{
				...
				message2 = XMLString::transcode(att.getValue(myXMLCh));
				if (message2 == NULL)	vecDaisy3NcxMetaContent.push_back("EmPtY");
				else					vecDaisy3NcxMetaContent.push_back(message2);
				XMLString::release(&myXMLCh);
				XMLString::release(&message2);
			...
			try
			{
				myXMLCh = XMLString::transcode("scheme");
				message2 = XMLString::transcode(att.getValue(myXMLCh));
				if (message2 == NULL)	vecDaisy3NcxMetaScheme.push_back("EmPtY");
				else					vecDaisy3NcxMetaScheme.push_back(message2);
				XMLString::release(&myXMLCh);
				XMLString::release(&message2);
			...
			catch (...)
			{
				...
				cout << "<Warning::LoadDaisy3NcxHandle::startElement::meta> This NCX has empty content in scheme tag." << endl;
			}
		}
		else
		{
	...
	{	
		...
		try		
		{
			myXMLCh = XMLString::transcode("id");
			message2 = XMLString::transcode(att.getValue(myXMLCh));
			if (message2 == NULL)	vecDaisy3NcxPartId.push_back("EmPtY");
			else					vecDaisy3NcxPartId.push_back(message2);
			XMLString::release(&myXMLCh);
			XMLString::release(&message2);
		...
		||!strcmp(message1,"navTarget")  || !strcmp(message1,"NavTarget")  || !strcmp(message1,"Navtarget")  || !strcmp(message1,"navtarget")  || !strcmp(message1,"NAVTARGET"))
	{
		...
		try
		{
			myXMLCh = XMLString::transcode("id");
			message2 = XMLString::transcode(att.getValue(myXMLCh));
			if (message2 == NULL)	vecDaisy3NcxBodyId.push_back("EmPtY");
			else					vecDaisy3NcxBodyId.push_back(message2);
			XMLString::release(&myXMLCh);
			XMLString::release(&message2);
		...
		try
		{
			myXMLCh = XMLString::transcode("playOrder");
			message2 = XMLString::transcode(att.getValue(myXMLCh));
			if (message2 == NULL)	vecDaisy3NcxBodyPlayOrder.push_back("EmPtY");
			else					vecDaisy3NcxBodyPlayOrder.push_back(message2);
			XMLString::release(&myXMLCh);
			XMLString::release(&message2);
