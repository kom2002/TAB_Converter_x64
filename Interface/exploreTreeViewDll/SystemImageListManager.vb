...
Imports TAB.Telephony.exploreTreeViewDll.ShellDll
...
#Region "       ImageList Related Constants"
    ...
    Private Const LVM_SETIMAGELIST As Object = (LVM_FIRST + 3)

    Private Const LVSIL_NORMAL As Object = 0
    Private Const LVSIL_SMALL As Object = 1
    Private Const LVSIL_STATE As Object = 2

    Private Const TV_FIRST As Object = &H1100
    Private Const TVM_SETIMAGELIST As Object = (TV_FIRST + 9)

    Private Const TVSIL_NORMAL As Object = 0
    Private Const TVSIL_STATE As Object = 2
#End Region
